      ...
      <div style={contentContainerStyle}>
        ...
        <p style={descriptionStyle}>
          <i>
            ...
            certifications and learn relevant skills. We thought of SkillHive to resolve that. Learning new skills and
            gaining more knowledge all while networking with talented people!
          </i>
        </p>
        <p style={descriptionStyle}>
          <br />
          At SkillHive, we believe in the power of learning and sharing knowledge. Our platform connects individuals
          from diverse backgrounds to exchange practical skills and expertise. Whether you're a seasoned professional
          looking to mentor others or a beginner eager to learn, SkillHive provides a supportive environment for growth
          and collaboration.
          <br />
          <br />
