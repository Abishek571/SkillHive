...
const Chats = () => {
  ...
  const handleChatClick = async (chatId) => {
    try {
      ...
      const { data } = await axios.get(`http://localhost:5000/message/getMessages/${chatId}`);
  ...
  const sendMessage = async (e) => {
    try {
      ...
      const { data } = await axios.post("http://localhost:5000/message/sendMessage", { chatId: selectedChat.id, content: message });
  ...
  const getRequests = async () => {
    try {
      ...
      const { data } = await axios.get("http://localhost:5000/request/getRequests");
  ...
  const handleRequestAccept = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post("http://localhost:5000/request/acceptRequest", { requestId: selectedRequest._id });
      console.log(data);
      toast.success(data.message);
  ...
  const handleRequestReject = async () => {
    ...
    try {
      setAcceptRequestLoading(true);
      const { data } = axios.post("http://localhost:5000/request/rejectRequest", { requestId: selectedRequest._id });
      console.log(data);
      toast.success(data.message);
      setRequests((prevState) => prevState.filter((request) => request._id !== selectedRequest._id));
    } catch (err) {
            ...
            <Form>
              ...
              <Button
                ...
                onClick={async (e) => {
                  ...
                  try {
                    const { data } = await axios.post("http://localhost:5000/user/sendScheduleMeet", scheduleForm);
